...
$plugin_slug_assets = [
	'admin' => [
		// The .asset.php file is generated by `npm run build` and lists the
		// script's WordPress dependencies plus a content-hash version.
		'asset_file' => PLUGIN_SLUG_DIR . 'build/admin-settings.asset.php',
		'script'     => plugins_url( 'build/admin-settings.js', PLUGIN_SLUG_FILE ),
		'style'      => plugins_url( 'build/admin-settings.css', PLUGIN_SLUG_FILE ),
	],
];
